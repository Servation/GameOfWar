            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style46" rowspan="2">
                        ...
                        <br />
                        <asp:Label ID="lblAAPlay" runat="server" Font-Size="XX-Large" Font-Bold="True" ForeColor="#660033" Enabled="False"></asp:Label>
                        <br />
                        <asp:Image ID="imgAAA" runat="server" Width="125px" BorderColor="#CCCCCC" BorderStyle="Groove" BorderWidth="6px" Visible="False" />
                        <br />
                        <asp:Label ID="lblAAAPlay" runat="server" Font-Size="XX-Large" Font-Bold="True" ForeColor="#660033" Enabled="False"></asp:Label>
                    </td>
                    ...
                    <td class="auto-style38" rowspan="2">
                        ...
                        <br />
                        <asp:Label ID="lblBBPlay" runat="server" Font-Size="XX-Large" Font-Bold="True" ForeColor="#660033" Enabled="False"></asp:Label>
                        <br />
                        <asp:Image ID="imgBBB" runat="server" Width="125px" BorderColor="#CCCCCC" BorderStyle="Groove" BorderWidth="6px" Visible="False" />
                        <br />
                        <asp:Label ID="lblBBBPlay" runat="server" Font-Size="XX-Large" Font-Bold="True" ForeColor="#660033" Enabled="False"></asp:Label>
                    </td>
                </tr>
                <tr>
